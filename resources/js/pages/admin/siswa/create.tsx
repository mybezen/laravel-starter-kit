// resources/js/pages/Admin/Siswa/Create.tsx
...
export default function CreateSiswa({ kelas }: Props) {
    ...
    return (
        <AppLayout
            breadcrumbs={[
                ...
                { label: 'Tambah Siswa', href: '/admin/siswa/create' },
            ]}
        >
            <div className="space-y-6 p-6">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-gray-500 mt-1">Tambahkan data siswa baru</p>
                    </div>
                </div>
